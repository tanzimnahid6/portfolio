          ...
          <div className="md:col-span-2 order-1 ">
            <div className=" text-white md:pl-16">
              ...
              <p className="leading-7 my-8">
                ...
                the ability to design and implement robust and scalable
                solutions for various business needs. I am proficient in
                creating RESTful APIs, building interactive user interfaces with
                React, handling data storage and retrieval with MongoDB, and
                developing server-side logic with Node.js and Express.js. I am
                experienced in working with front-end frameworks, version
                control systems, and deploying applications to cloud platforms.
              </p>
